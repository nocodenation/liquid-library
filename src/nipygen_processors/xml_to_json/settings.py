...
DESCRIPTION = "This processor transforms a xml file to a json file."
# TAGS contains a list of  tags for the Python Processor
TAGS = ["convert", "xml", "json"]
...
SYSTEM_DEPENDENCIES = ["test", "test2"]
...
# Result data may be routed to `failure` but not to `original`.
RESULT_DATA_TO_RELATIONSHIP_NAME_TRANSFORMATION = None
